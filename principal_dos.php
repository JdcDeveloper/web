		...
		<div class="container">
			 <div class="row">
  				<div class="video col-xs-10 col-sm-10 col-md-10 col-lg-10">
  					...
  					<iframe width="560" height="315" src="https://www.youtube.com/embed/M4uCRncR3_w" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe>

					<nav aria-label="Page navigation" class="pull-left">
					  <ul class="pagination">
					    <li>
					      <a href="principal_dos.php" aria-label="Previous">
					    ...
					    <li>
					      <a href="principal_tres.php" aria-label="Next">
